...
use super::{Cancel, Confirm, clear_button};
...
impl DateTimePickerState {
    ...
    fn set_canlendar_disabled_matcher(&mut self, _: &mut Window, cx: &mut Context<Self>) {
        ...
        self.calendar
            .update(cx, |state, _| state.set_disabled_matcher_shared(matcher));
    }
